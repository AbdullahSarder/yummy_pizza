...
class Pizza:
 ...
 def main(sf):
     ...
     sf.scr.title("YUMMY PIZZA")
     # sf.scr.resizable(False, False)
     sf.scr.iconbitmap('images/all_images/p.ico')
     sf.mainf1 = Frame(sf.scr, height=0, width=1366)
     ...
     sf.mainf2 = Frame(sf.scr, height=819, width=1366)
     sf.c = Canvas(sf.mainf2, height=819, width=1366)
     sf.c.pack()
     sf.back = PhotoImage(file="images/home/homepage_background.png")
     sf.c.create_image(680, 410, image=sf.back)
     sf.lab = Button(sf.mainf2, text="Start", command=lambda: sf.Login(),
                     cursor="hand2", bd=0, font=("inter", 18, 'bold'), fg="white", bg="#F3AB1D")
     sf.lab.place(x=680, y=517)
 ...
 def Login(sf):
     ...
     sf.scr.geometry("1366x768")
     # sf.scr.resizable(False, False)
     sf.loginf1 = Frame(sf.scr, height=40, width=1366, bg="black")
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     sf.ba = Label(sf.loginf1, image=sf.logo, height=100).place(x=40, y=0)
     sf.home = Button(sf.loginf1, text="Home", command=lambda: sf.main(), bg="#F3AB1D", cursor="hand2", bd=1,
                      fg="white", font=("inter", 16))
     sf.home.place(x=1200, y=30)
     ...
     sf.c.pack()
     sf.logo1 = PhotoImage(file="images/login/login_bg.png")
     ...
     sf.rg = Button(sf.loginf2, text="Admin Login", command=lambda: sf.Adminlogin(), fg="white", cursor="hand2",
                    bg="#F3AB1D", font=("inter", 20), bd=1)
     sf.rg.place(x=370, y=250)
     ...
     sf.rg = Button(sf.loginf2, text="Staff Login", command=lambda: sf.Register(), fg="white", cursor="hand2",
                    bg="#F3AB1D", font=("inter", 20), bd=1)
     sf.rg.place(x=370, y=350)
     ...
     sf.rg = Button(sf.loginf2, text="Customer Login", command=lambda: sf.CustomerLogin(), fg="white", cursor="hand2",
                    bg="#F3AB1D", font=("inter", 20), bd=1)
     sf.rg.place(x=370, y=450)
 ...
 def CustomerLogin(sf):
     ...
     sf.scr.geometry("1366x768")
     # sf.scr.resizable(False, False)
     sf.loginf1 = Frame(sf.scr, height=100, width=1366, bg="#F3AB1D")
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     sf.ba = Label(sf.loginf1, image=sf.logo, height=100).place(x=40, y=0)
     sf.home = Button(sf.loginf1, text="Home", command=lambda: sf.main(), bg="#F3AB1D", cursor="hand2", bd=1,
                      fg="white", font=("inter", 16))
     sf.home.place(x=1000, y=50)
     ...
     sf.logo1 = PhotoImage(file="images/login/login_bg.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.c.create_rectangle(50, 100, 700, 450, fill="white", outline="white", width=6)
     sf.log = Label(sf.loginf2, text="LOGIN", fg="black", bg="white", width=26, font=("inter", 27))
     sf.log.place(x=59, y=105)
     sf.lab1 = Label(sf.loginf2, text="User Name", bg="white", font=("inter", 22))
     sf.lab1.place(x=100, y=180)
     sf.user = Entry(sf.loginf2, bg="white", font=("inter", 22), bd=1, justify='left')
     sf.user.place(x=320, y=180)
     sf.lab2 = Label(sf.loginf2, text="Password", bg="white", font=("inter", 22))
     sf.lab2.place(x=105, y=250)
     sf.pasd = Entry(sf.loginf2, bg="white", font=("inter", 22), bd=1, justify='left')
     sf.pasd.place(x=320, y=250)
     sf.lg = Button(sf.loginf2, text="Login", cursor="hand2", command=lambda: sf.logindatabase(), fg="white",
                    bg="#F3AB1D", font=("inter", 20), bd=1, width=10)
     sf.lg.place(x=480, y=320)
     ...
     sf.rg = Button(sf.loginf2, text="New to Yummy Pizza", command=lambda: sf.Register(), fg="blue", cursor="hand2",
                    bg="white", font=("inter", 20), bd=1)
     sf.rg.place(x=370, y=390)
 ...
 def Adminlogin(sf):
     ...
     sf.c.pack()
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     sf.c.create_image(100, 75, image=sf.logo)
     ...
     sf.c.pack()
     sf.logo1 = PhotoImage(file="images/login/5923943.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     # sf.c.create_rectangle(350, 100, 1016, 450, fill="#d3ede6", outline="white", width=6)
     sf.log = Label(sf.adminf2, text="ADMIN LOGIN", fg="black",bg="white", width=27, font=("inter", 27))
     sf.log.place(x=597, y=110)
     sf.lab1 = Label(sf.adminf2, text="UserName", bg="white",fg="black", font=("inter", 22))
     sf.lab1.place(x=550, y=200)
     sf.usera = Entry(sf.adminf2, bg="white", font=("inter", 22), bd=1)
     sf.usera.place(x=720, y=200)
     sf.lab2 = Label(sf.adminf2, text="Password", bg="white",fg="black", font=("inter", 22))
     sf.lab2.place(x=550, y=270)
     sf.pasda = Entry(sf.adminf2, bg="white", font=("inter", 22), bd=1)
     sf.pasda.place(x=720, y=270)
     sf.lg = Button(sf.adminf2, text="Login", cursor="hand2", fg="white", bg="#0b1335",
                    command=lambda: sf.admindatabase(), font=("inter", 20, 'bold'), bd=1)
     sf.lg.place(x=930, y=350)
     sf.cl = Button(sf.adminf2, text="Back", cursor="hand2", fg="white", bg="#0b1335", command=lambda: sf.Login(),
                    font=("inter", 20, 'bold'), bd=1)
     sf.cl.place(x=830, y=350)
 ...
 def Register(sf):
     ...
     sf.scr.geometry("1366x768")
     # sf.scr.resizable(False, False)
     sf.regf1 = Frame(sf.scr, height=100, width=1366)
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     ...
     sf.log = Label(sf.regf2, text="REGISTRATION", fg="white", bg="#0b1335", width=20, font=("inter", 27))
     sf.log.place(x=480, y=120)
     sf.lab1 = Label(sf.regf2, text="FirstName", bg="#d3ede6", font=("inter", 18))
     sf.lab1.place(x=190, y=200)
     sf.first = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     sf.first.place(x=430, y=200)
     sf.lab2 = Label(sf.regf2, text="LastName", bg="#d3ede6", font=("inter", 18))
     sf.lab2.place(x=730, y=200)
     sf.last = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     sf.last.place(x=920, y=200)
     sf.lab3 = Label(sf.regf2, text="Username", bg="#d3ede6", font=("inter", 18))
     sf.lab3.place(x=190, y=250)
     sf.usern = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     sf.usern.place(x=430, y=250)
     sf.lab4 = Label(sf.regf2, text="Password", bg="#d3ede6", font=("inter", 18))
     sf.lab4.place(x=730, y=250)
     sf.passd = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     sf.passd.place(x=920, y=250)
     sf.lab5 = Label(sf.regf2, text="Email", bg="#d3ede6", font=("inter", 18))
     sf.lab5.place(x=190, y=300)
     sf.email = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     sf.email.place(x=430, y=300)
     sf.lab6 = Label(sf.regf2, text="Mobile No.", bg="#d3ede6", font=("inter", 18))
     sf.lab6.place(x=730, y=300)
     sf.mob = Entry(sf.regf2, bg="white", width=15, font=("inter", 18), bd=5)
     ...
     sf.rg = Button(sf.regf2, text="Register", cursor="hand2", fg="white", bg="#0b1335",
                    command=lambda: sf.Regdatabase(), font=("inter", 18), bd=5)
 ...
 def adminmain(sf):
     ...
     sf.c.create_text(683, 125, font=('inter', 25, 'bold', 'underline'), text="Management System")
     ...
     def Ref(sf):
         ...
         sf.v1 = sf.vp1.get()
         if sf.v1 == "Medium":
             sf.p1 = float(sf.Deluxe_Veggie.get()) *11
         elif sf.v1 == "Large":
             sf.p1 = float(sf.Deluxe_Veggie.get()) *20
         else:
             sf.p1 = float(sf.Deluxe_Veggie.get()) * 7
         sf.v2 = sf.vp2.get()
         if sf.v2 == "Medium":
             sf.p2 = float(sf.Veg_Vaganza.get()) * 12
         elif sf.v2 == "Large":
             sf.p2 = float(sf.Veg_Vaganza.get()) * 20
         else:
             sf.p2 = float(sf.Veg_Vaganza.get()) * 7
         sf.v3 = sf.vp3.get()
         if sf.v3 == "Medium":
             sf.p3 = float(sf.Pepper.get()) * 12
         elif sf.v3 == "Large":
             sf.p3 = float(sf.Pepper.get()) * 15
         else:
             sf.p3 = float(sf.Pepper.get()) * 5
         sf.v4 = sf.vp4.get()
         if sf.v4 == "Medium":
             sf.p4 = float(sf.Margherita.get()) * 10
         elif sf.v4 == "Large":
             sf.p4 = float(sf.Margherita.get()) * 12
         else:
             sf.p4 = float(sf.Margherita.get()) * 9
         sf.v5 = sf.vp5.get()
         if sf.v5 == "Medium":
             sf.p5 = float(sf.Non_Veg_Supreme.get()) *11
         elif sf.v5 == "Large":
             sf.p5 = float(sf.Non_Veg_Supreme.get()) *20
         else:
             sf.p5 = float(sf.Non_Veg_Supreme.get()) * 7
         sf.v6 = sf.vp6.get()
         if sf.v6 == "Medium":
             sf.p6 = float(sf.Chicken_Tikka.get()) * 12
         elif sf.v6 == "Large":
             sf.p6 = float(sf.Chicken_Tikka.get()) * 20
         else:
             sf.p6 = float(sf.Chicken_Tikka.get()) * 5
         sf.v7 = sf.vp7.get()
         if sf.v7 == "Medium":
             sf.p7 = float(sf.Chicken_Sausage.get()) * 12
         elif sf.v7 == "Large":
             sf.p7 = float(sf.Chicken_Sausage.get()) * 15
         else:
             sf.p7 = float(sf.Chicken_Sausage.get()) * 5
         sf.v8 = sf.vp8.get()
         if sf.v8 == "Medium":
             sf.p8 = float(sf.Chicken_Peri.get()) * 10
         elif sf.v8 == "Large":
             sf.p8 = float(sf.Chicken_Peri.get()) * 12
         else:
             sf.p8 = float(sf.Chicken_Peri.get()) * 9
         sf.p9 = float(sf.Roasted_Chicken.get()) * 5
         sf.p10 = float(sf.Chicken_Meatballs.get()) * 9
         sf.p11 = float(sf.Boneles_sChicken.get()) * 6
         sf.p12 = float(sf.Coke_Mobile.get()) * 11
         sf.p13 = float(sf.Burger_Pizza.get()) * 9
         sf.p14 = float(sf.White_Pasta.get()) * 5
     ...
     def price(sf):
         ...
         sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="$15/$20/$9", fg="steel blue", anchor=W)
         ...
         sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="$15/$15/$9", fg="steel blue", anchor=W)
         ...
         sf.lblinfo = Label(sf.roo, font=('aria', 15, 'bold'), text="Drinks", fg="black", anchor=W)
     ...
     # veg pizza
     sf.non = Label(sf.admainf2, pady=2, text=(" "), font=('inter', 20), bg="#f2e8b8", bd=10, anchor='w')
     sf.non.grid(row=0, column=1)
     sf.lbl1 = Label(sf.admainf2, pady=2, font=('inter', 20, 'bold', 'underline'), bg="#f2e8b8",
                     text="Veg Pizza", bd=10, anchor='w')
     sf.lbl1.place(x=180, y=0)
     sf.lbl11 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=6, bg="#f2e8b8",
                      text="Items", bd=6, anchor='w')
     sf.lbl11.grid(row=1, column=0)
     sf.lbl12 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=7, bg="#f2e8b8",
                      text="Size", bd=6, anchor='w')
     sf.lbl12.grid(row=1, column=1)
     sf.lbl13 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=8, bg="#f2e8b8",
     ...
     sf.lbl2 = Label(sf.admainf2, pady=2, font=('inter', 20, 'bold', 'underline'), bg="#f2e8b8",
                     text="Non-Veg Pizza", bd=10, anchor='w')
     sf.lbl2.place(x=150, y=290)
     sf.lbl21 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=6, bg="#f2e8b8",
                      text="Items", bd=6, anchor='w')
     sf.lbl21.grid(row=7, column=0)
     sf.lbl22 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=7, bg="#f2e8b8",
                      text="Size", bd=6, anchor='w')
     sf.lbl22.grid(row=7, column=1)
     sf.lbl23 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=8, bg="#f2e8b8",
                      text="Quantity", bd=6, anchor='w')
     ...
     sf.lbl3 = Label(sf.admainf2, pady=2, font=('inter', 20, 'bold', 'underline'), bg="#f2e8b8",
                     text="Specialty", bd=10, anchor='w')
     sf.lbl3.place(x=550, y=0)
     sf.lbl31 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=6, bg="#f2e8b8",
                      text="Items", bd=6, anchor='w')
     sf.lbl31.grid(row=1, column=4)
     sf.lbl33 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=8, bg="#f2e8b8",
                      text="Quantity", bd=6, anchor='w')
     ...
     sf.lblros = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Creamy mushroom pasta:", bg="#f2e8b8",
                       fg="#7769ad", bd=6, anchor='w')
     ...
     sf.lbl4 = Label(sf.admainf2, pady=2, font=('inter', 20, 'bold', 'underline'), bg="#f2e8b8",
                     text="Drinks", bd=10, anchor='w')
     sf.lbl4.place(x=500, y=290)
     sf.lbl41 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=6, bg="#f2e8b8",
                      text="Items", bd=6, anchor='w')
     sf.lbl41.grid(row=7, column=4)
     sf.lbl43 = Label(sf.admainf2, pady=2, font=('inter', 16, 'underline'), width=8, bg="#f2e8b8",
                      text="Quantity", bd=6, anchor='w')
     ...
     sf.lbl6 = Label(sf.admainf2, pady=2, font=('inter', 22, 'bold', 'underline'), bg="#f2e8b8",
     ...
     sf.lbl5 = Label(sf.admainf2, pady=2, font=('inter', 22, 'bold', 'underline'), bg="#f2e8b8",
     ...
     sf.non = Label(sf.admainf2, pady=2, text=(" "), font=('inter', 20), width=5, bg="#f2e8b8", bd=10,
                    anchor='w')
 ...
 def menulist(sf, x):
     ...
     sf.scr.destroy()
     sf.scr = Tk()
     sf.scr.title("Yummy Pizza Menu List")
     sf.scr.iconbitmap('images/all_images/p.ico')
     sf.scr.geometry("1366x768")
     # sf.scr.resizable(False, False)
     ...
     sf.home = Button(sf.menuf1, text="Log Out", command=lambda: sf.Login(), bg="#0b1335", cursor="hand2",
                      fg="white", bd=1, font=("default", 16, 'bold'))
     sf.home.place(x=1000, y=90)
     sf.localtime = time.asctime(time.localtime(time.time()))
     ...
     sf.c.pack()
     # background image
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.c.create_rectangle(50, 140, 1316, 420, fill="#d3ede6", outline="white", width=6)
     sf.veg = PhotoImage(file="images/all_images/veg.png")
     sf.c.create_image(230, 250, image=sf.veg)
     # sf.traditional = Button(sf.menuf2, text="Veg Pizza", cursor="hand2", fg="white", command=lambda: sf.traditional_pizza(sf.x),
     sf.traditional = Button(sf.menuf2, text="traditional", cursor="hand2", fg="white", command=lambda: sf.traditional_pizza(sf.x),
                        bg="#0b1335", bd=1, font=("default", 18, 'bold'))
     sf.traditional.place(x=170, y=350)
     sf.nonveg = PhotoImage(file="images/all_images/Non.png")
     sf.c.create_image(530, 250, image=sf.nonveg)
     sf.nontraditional = Button(sf.menuf2, text="Wholemeal", cursor="hand2", fg="white",
                           command=lambda: sf.wholemeal(sf.x), bg="#0b1335", bd=5, font=("default", 18, 'bold'))
     sf.nontraditional.place(x=440, y=350)
     sf.chi = PhotoImage(file="images/all_images/chiken.png")
     sf.c.create_image(830, 250, image=sf.chi)
     sf.chibut = Button(sf.menuf2, text="Pasta", cursor="hand2", fg="white",
                        command=lambda: sf.Pasta(sf.x), bg="#0b1335", bd=5, font=("default", 18, 'bold'))
     sf.chibut.place(x=730, y=350)
     sf.side = PhotoImage(file="images/all_images/extra.png")
     sf.c.create_image(1130, 250, image=sf.side)
     sf.sidebut = Button(sf.menuf2, text="Drinks", cursor="hand2", fg="white",
 ...
 def pizmain(sf):
     ...
     sf.deli = PhotoImage(file="images/all_images/delivery.png")
     sf.c.create_image(540, 260, image=sf.deli)
     sf.pic = PhotoImage(file="images/all_images/pick.png")
 ...
 def traditional_pizza(sf, x):
     ...
     sf.scr.iconbitmap('images/all_images/p.ico')
     # sf.scr.resizable(False, False)
     sf.tred1 = Frame(sf.scr, height=150, width=1366)
     sf.c = Canvas(sf.tred1, height=150, width=1366)
     sf.c.pack()
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     sf.c.create_image(683, 75, image=sf.logo)
     sf.home = Button(sf.tred1, text="Log Out", command=lambda: sf.Login(), bg="#0b1335", cursor="hand2", fg="white",
                      bd=5, font=("default", 16, 'bold'))
     sf.home.place(x=1000, y=90)
     sf.localtime = time.asctime(time.localtime(time.time()))
     sf.c.create_text(1000, 50, text=sf.localtime, fill="white", font=("default", 16))
     sf.tred1.pack(fill=BOTH, expand=1)
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.vegf2, text="Traditional PIZZA", bg="#9db1f2", font=("inter", 22))
     ...
     sf.delu = PhotoImage(file="images/all_images/deluxe.png")
     sf.c.create_image(470, 110, image=sf.delu)
     sf.c.create_text(650, 80, text="Supreme", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 80, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     def addch1():
         if sf.v1.get() == 10:
             ...
             ch1 = "Regular"
             pric1 = 9
         sf.addlist(["Traditional Supreme", ch1, sf.q1.get(), pric1 * int(sf.q1.get())])
     ...
     sf.vag = PhotoImage(file="images/all_images/extravaganza.png")
     sf.c.create_image(470, 230, image=sf.vag)
     sf.c.create_text(650, 200, text="sausage sizzle", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 200, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     sf.pep = PhotoImage(file="images/all_images/5-pepper-veg-pizza.png")
     sf.c.create_image(470, 350, image=sf.pep)
     sf.c.create_text(650, 320, text="Hawaiian", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 320, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     sf.mag = PhotoImage(file="images/all_images/Margherit.png")
     sf.c.create_image(470, 470, image=sf.mag)
     sf.c.create_text(650, 440, text="Traditional Chicken", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 440, text="$15/$15/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     sf.scr.mainloop() # --  Traditional Pizza------
 def Wholemeal_pizza(sf, x):
     sf.x = x
     sf.scr.destroy()
     sf.scr = Tk()
     sf.scr.title("Yummy Pizza")
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.vegf2, text="Wholemeal PIZZA", bg="#9db1f2", font=("inter", 22))
     sf.log.place(x=600, y=4)
     sf.c.create_rectangle(400, 40, 966, 540, fill="#d3ede6", outline="white", width=6)
     sf.q1 = StringVar()
     sf.q2 = StringVar()
 ...
 def wholemeal(sf, x):
     ...
     sf.scr.geometry("1366x768")
     # sf.scr.resizable(False, False)
     sf.nontred1 = Frame(sf.scr, height=150, width=1366)
     sf.c = Canvas(sf.nontred1, height=150, width=1366)
     sf.c.pack()
     sf.logo = PhotoImage(file="images/logo/yummi_pizza_logo.png")
     sf.c.create_image(683, 75, image=sf.logo)
     sf.home = Button(sf.nontred1, text="Log Out", command=lambda: sf.Login(), bg="#0b1335", cursor="hand2",
                      fg="white", bd=5, font=("default", 16, 'bold'))
     sf.home.place(x=1000, y=90)
     sf.localtime = time.asctime(time.localtime(time.time()))
     sf.c.create_text(1000, 50, text=sf.localtime, fill="white", font=("default", 16))
     sf.nontred1.pack(fill=BOTH, expand=1)
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.nonvegf2, text="Wholemeal Pizza", bg="#9db1f2", font=("inter", 22))
     ...
     # pizza 1
     sf.c.create_rectangle(405, 50, 960, 170, width=2)
     sf.delu = PhotoImage(file="images/all_images/Non-Veg_Supreme.png")
     sf.c.create_image(470, 110, image=sf.delu)
     sf.c.create_text(650, 80, text="Non-Veg Supreme", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 80, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     # pizza 2
     sf.c.create_rectangle(405, 170, 960, 290, width=2)
     sf.vag = PhotoImage(file="images/all_images/nonChicken_Tikka.png")
     sf.c.create_image(470, 230, image=sf.vag)
     sf.c.create_text(650, 200, text="Chicken Tikka", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 200, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     # pizza 3
     sf.c.create_rectangle(405, 290, 960, 410, width=2)
     sf.pep = PhotoImage(file="images/all_images/non-Chicken_Sausage.png")
     sf.c.create_image(470, 350, image=sf.pep)
     sf.c.create_text(650, 320, text="Chicken Sausage", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 320, text="$15/$20/$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     # pizza 4
     sf.c.create_rectangle(405, 410, 960, 530, width=2)
     sf.mag = PhotoImage(file="images/all_images/no-LoadedL.png")
     sf.c.create_image(470, 470, image=sf.mag)
     sf.c.create_text(650, 440, text="Chicken Peri", fill="#000000", font=("inter", 20))
     sf.c.create_text(860, 440, text="$15/$15/$9", fill="#ff3838", font=("default", 17, 'bold'))
 ...
 def Pasta(sf, x):
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.spef2, text="Pasta", bg="#9db1f2", font=("inter", 22))
     ...
     sf.c.create_rectangle(405, 50, 960, 170, width=2)
     sf.delu = PhotoImage(file="images/pizza/pasta/chicken-and-mushroom-pasta.png")
     sf.c.create_image(470, 110, image=sf.delu)
     sf.c.create_text(650, 80, text="Creamy mushroom pasta", fill="#000000", font=("inter", 20))
     sf.c.create_text(875, 80, text="$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     sf.add9 = Button(sf.spef2, text="ADD",
                      command=lambda: sf.addlist(["Creamy mushroom pasta", sf.q9.get(), 9 * int(sf.q9.get())]),
                      bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
     sf.add9.place(x=850, y=120)
     # classic Bolognese pasta
     sf.c.create_rectangle(405, 170, 960, 290, width=2)
     sf.vag = PhotoImage(file="images/pizza/pasta/classic Bolognese pasta.png")
     sf.c.create_image(470, 230, image=sf.vag)
     sf.c.create_text(650, 200, text="classic Bolognese pasta", fill="#000000", font=("inter", 20))
     sf.c.create_text(875, 200, text="$9", fill="#ff3838", font=("default", 17, 'bold'))
     ...
     sf.add10 = Button(sf.spef2, text="ADD",
                       command=lambda: sf.addlist(["Chicken Meatballs", sf.q10.get(), 9 * int(sf.q10.get())]),
                       bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
 ...
 def sidebev(sf, x):
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.sidef2, text="Drinks", bg="#9db1f2", font=("inter", 22))
     ...
     # pizza 1
     sf.c.create_rectangle(405, 50, 960, 170, width=2)
     sf.delu = PhotoImage(file="images/all_images/coke.png")
     sf.c.create_image(470, 110, image=sf.delu)
     sf.c.create_text(650, 80, text="Coke Mobile", fill="#000000", font=("inter", 20))
     ...
     # pizza 2
     sf.c.create_rectangle(405, 170, 960, 290, width=2)
     sf.vag = PhotoImage(file="images/all_images/burger.png")
     sf.c.create_image(470, 230, image=sf.vag)
     sf.c.create_text(650, 200, text="Burger Pizza", fill="#000000", font=("inter", 20))
     ...
     # pizza 3
     sf.c.create_rectangle(405, 290, 960, 410, width=2)
     sf.pep = PhotoImage(file="images/all_images/white.png")
     sf.c.create_image(470, 350, image=sf.pep)
     sf.c.create_text(650, 320, text="White Pasta", fill="#000000", font=("inter", 20))
 ...
 def Orderde(sf, x):
     ...
     sf.logo1 = PhotoImage(file="images/all_images/pizzamain.png")
     sf.c.create_image(683, 309, image=sf.logo1)
     sf.log = Label(sf.ordf2, text="YOUR ORDER", bg="#9db1f2", font=("inter", 22))
     sf.log.place(x=450, y=4)
     sf.c.create_rectangle(250, 50, 800, 500, fill="#d3ede6", outline="white", width=6)
     sf.amt = sf.amount
     sf.text = "Total : " + str(sf.amt)
     sf.tot = Label(sf.ordf2, text=sf.text, bg="#f2da9d", width=12, font=("inter", 22))
     ...
     sf.c.create_text(525, 80, text="Items\tSize\tQty\tPrice", font=("inter", 18))
     sf.c.create_text(525, 90, text="_______________________________________", font=("inter", 18))
     y = 100
 ...
 def logindatabase(sf):
     ...
     try:
         cursor.execute(
             "CREATE TABLE IF NOT EXISTS customer (username VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, first VARCHAR(50) NOT NULL, last VARCHAR(50) NOT NULL, email VARCHAR(50), mob VARCHAR(50) NOT NULL)")
     ...
     query = "SELECT COUNT(*) FROM customer WHERE username=%s AND password=%s"
     cursor.execute(query, (sf.credlog[0], sf.credlog[1]))
 ...
 def Regdatabase(sf):
     ...
     try:
         ...
         print("Error creating customer table:", err)
     ...
     sf.cur.execute(
         "SELECT COUNT(*) FROM customer WHERE username=%s AND mob=%s",
         (sf.credreg[0], sf.credreg[5])
     )
 ...
 def admindatabase(sf):
     ...
     # Execute the query
     cursor.execute("SELECT COUNT(*) FROM admin WHERE username = %s AND password = %s",
                    (sf.credadm[0], sf.credadm[1]))
     result = cursor.fetchone()
 ...
 def adminorderdetail(sf):
     ...
     if sf.money != 0 and sf.credadmord[0] != "" and sf.credadmord[1] != "":
         if messagebox.askyesno("Pay", "Want to make payment"):
             ...
             # Create orderdetail table if it doesn't exist
             try:
                 cursor.execute(
                     "CREATE TABLE IF NOT EXISTS orderdetail (id INT PRIMARY KEY AUTO_INCREMENT, username VARCHAR(50), name VARCHAR(50), mobile VARCHAR(50), money VARCHAR(10) NOT NULL, address VARCHAR(50), orderdet VARCHAR NOT NULL)")
             ...
             query = "INSERT INTO orderdetail (name, mobile, money, orderdet) VALUES (%s, %s, %s, %s)"
             values = (a, b, str(sf.money), str(od))
         ...
         messagebox.showinfo("Pay", "Enter Customer's Name, Mobile No, and Order Something")
